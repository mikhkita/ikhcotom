<?include "header.php";?>
	<div class="b-content-inner">
		<div class="b-block">
			...
			<h2 class="b-title b-title-left">Доставка и оплата</h2>
			<div class="b-delivery-info">
				<div class="delivery-info-item">
					<div class="delivery-info-item-title">Совершить покупку<br> в нашем магазине очень просто</div>
					<p>Заказы принимаются круглосуточно на нашем сайте <a href="/">motochki-klubochki.ru</a>. <b>Заказы по телефону не принимаются.</b></p>
					...
					<ul class="delivery-info-list">
						...
						<li><a href="#" target="_blank">Политика конфиденциальности персональных данных</a></li>
						<li><a href="#" target="_blank">Договор оферта</a></li>
					</ul>
				</div>
			...
			<div class="b-payment">
				...
				<ul class="payment-list">
					<li>
						<div class="payment-list-image"><img src="i/payment-img-1.svg" alt=""></div>
						<div class="payment-list-text">Банковской картой на сайте</div>
					</li>
					<li>
						<div class="payment-list-image"><img src="i/payment-img-2.svg" alt=""></div>
			...
			<div class="b-delivery-methods">
				...
				<div class="delivery-methods-list">
					<div class="delivery-method">
						<div class="delivery-method-image"><img src="i/delivery-method-1.svg" alt=""></div>
					...
					<div class="delivery-method">
						<div class="delivery-method-image"><img src="i/delivery-method-2.svg" alt=""></div>
					...
					<div class="delivery-method">
						<div class="delivery-method-image"><img src="i/delivery-method-3.svg" alt=""></div>
					...
					<div class="delivery-method">
						<div class="delivery-method-image"><img src="i/delivery-method-4.svg" alt=""></div>
