	...
	<div class="b-content-inner no-margin">
		<div class="b b-about-head">
			<div class="b-block">
				...
				<h2 class="b-title b-title-left">О магазине</h2>
			</div>
		</div>
		<div class="b b-about-face">
			<div class="b-block">
				<div class="about-face-title">Интернет-магазин пряжи</div>
				<img src="i/about-face-img.svg" alt="" class="about-face-img">
		...
		<div class="b b-about-articles-block">
			<div class="b-block">
				...
				<a href="#" class="b-btn">Читать блог</a>
			</div>
		</div>
				...
				<div class="about-qwestions-form">
					...
					<form>
						<div class="b-inputs-2 clearfix">
							<div class="b-input"><input type="text" name="name" placeholder="Ваше имя"></div>
							<div class="b-input"><input type="text" name="phone" placeholder="Номер телефона"></div>
						</div>
